                    ...
                    xhr1.onreadystatechange = function () {
                        if (xhr1.readyState == 4) {
                            if (xhr1.status >= 200 && xhr1.status < 300) {
                                ...
                                console.log(xhr1.response.account);
                                console.log(xhr1.response.profile);
                                console.log(xhr1.response.profile.avatarUrl);
                                console.log(xhr1.response.profile.nickname);
                                console.log(xhr1.response.profile.level);
                            }
                        }
                    }
                    //获取用户详情后同步到页面中
