        ...
        if (xhr.readyState === 4) {
            if (xhr.status >= 200 && xhr.status < 300) {
                ...
                if (User.code == 200) {
                    ...
                    //添加头像
                    headPic.innerHTML = "";
                    // headPic.style.backgroundImage = 'url(' + cookie.profile.avatarUrl + ')';
                    headPic.style.borderRadio = "20px";
                                ...
                                xhr2.onreadystatechange = function () {
                                    if (xhr2.readyState == 4) {
                                        if (xhr2.status >= 200 && xhr2.status < 300) {
                                            ...
                                            var userInformation = sessionStroage.getItem('userInform');
                                            names.innerHTML = userInformation.profile.nickname;
                                            headPic.style.backgroundImage = 'url(' + userInformation.profile.avatarUrl + ')';
