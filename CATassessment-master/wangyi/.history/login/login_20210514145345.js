...
//微信，qq，微博登录的提示窗口
let u_mlg2_wx = document.getElementsByClassName('a-wx')[0];
let u_mlg2_qq = document.getElementsByClassName('a-qq')[0];
let u_mlg2_wb = document.getElementsByClassName('a-wb')[0];
