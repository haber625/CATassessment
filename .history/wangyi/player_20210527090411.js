...
let playingLine = function () {
    ...
    play_lineCur.addEventListener('click', function (e) {
        var x = e.pageX;
        play_lineCur.style.width = e.pageX - play_lineCur.style.left + 'px';
    })
...
// get('http://localhost:3000/playlist/cover/update?id=108418&imgSize=200', '', function () {
//     console.log(4);
// })
var xhr12 = new XMLHttpRequest;
xhr12.open('get', 'http://localhost:3000/playlist/cover/update?id=108418&imgSize=200');
xhr12.setRequestHeader('Content-Type', 'multipart/form-data')
xhr12.send();
