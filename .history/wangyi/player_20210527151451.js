...
let playingLine = function () {
    ...
    play_lineCur.addEventListener('click', function (event) {
        console.log(play_lineCur.offsetLeft);
        console.log(play_lineCur.offsetParent);
    })
...
————————————————
版权声明：本文为CSDN博主「wu209000」的原创文章，遵循CC 4.0 BY - SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/wu209000/article/details/83797478
